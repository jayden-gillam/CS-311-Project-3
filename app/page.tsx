...
export default function Page() {
  ...
  return (
    <div className="p-8 bg-gray-100 min-h-screen">
      <h1 className="text-2xl font-bold text-center mb-8">Cooking Recipe Generator</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <form className="bg-white p-6 shadow-md rounded-md" action={addMethod}>
          <h2 className="text-lg font-semibold mb-4">Add Cooking Method</h2>
          <input
            type="text"
        ...
        <form className="bg-white p-6 shadow-md rounded-md" action={addCookingStep}>
          <h2 className="text-lg font-semibold mb-4">Add Cooking Step</h2>
          <input
            type="text"
